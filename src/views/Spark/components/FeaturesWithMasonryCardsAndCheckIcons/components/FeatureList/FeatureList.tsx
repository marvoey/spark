    ...
    <Box>
      ...
      <Box marginBottom={2}>
        <Typography variant={'h4'} sx={{fontWeight: 700}} gutterBottom>
          Don’t let your CMS dictate the way you work
        </Typography>
        <Typography color="text.secondary" variant={'h6'}>
          Get more out of your tech investments while increasing efficiencies when you connect content to backend systems.
        </Typography>
      </Box>
